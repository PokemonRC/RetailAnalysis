# Our purpose is to -
#   1. filter orders dataframe based on order_status = 'CLOSED'
#   2. join filtered orders dataframe with customers dataframe
#   3. count the no. of CLOSED orders in each state
